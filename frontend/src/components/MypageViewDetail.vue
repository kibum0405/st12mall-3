<template>
    ...
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="ProudctId" v-model="item.proudctId" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="OrderState" v-model="item.orderState" :editMode="editMode" @change="change" />
            </div>
            <div>
